...
<p>And for Hexidecimal we append an 0X
...
<p>As We have stated, Eight Bits make a Byte. Continuing on with Hexidecimal, a Byte is two columns (3E). From there we move up to a Halfword (003E). A Halfword is four Bytes, and a < href="https://en.wikipedia.org/wiki/Word_(computer_architecture)">Word</a> (0000003E) is eight. Before we go too far, lets scale our bits.</p>

<pre>
3E					// Byte (8 Bits)
003E				// Halfword (16 Bits)
0000003E			// Word (32 Bits)
000000000000003E	// Doubleword (64 bits)
</pre>
